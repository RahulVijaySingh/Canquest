            ...
            <div className='bg-secondary'>
                ...
                <div style={{ padding: "30px", display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
                    ...
                    {/* <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="jio1.cms" style={{ width: '100%', height: '400px', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div> */}
                    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="jio2.webp" style={{ width: '100%', height: '400px', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div>
                    {/* <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="jio3.webp" style={{ width: '100%', height: '400px', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div>
                    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="jio4.webp" style={{ width: '100%', height: '400px', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div>
                    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="jio5.jpeg" style={{ width: '100%', height: 'auto', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div>
                    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="jio6.avif" style={{ width: '100%', height: 'auto', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div>
                    <div style={{ width: '50%', padding: '10px', boxSizing: 'border-box' }}>
                        <img src="Jio7.webp" style={{ width: '100%', height: 'auto', margin: '5px', objectFit: 'cover' }} alt="..." />
                    </div> */}
